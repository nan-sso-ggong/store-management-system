...
class OrderService(
    ...
    private val orderRepository: OrderRepostiory,
    ...
    fun readCustomerOrder(storeId: Long, customerOrderRequestDto: CustomerOrderRequestDto): ListResponseDto<List<CustomerOrderResponseDto>> {
        ...
        val customerOrderList: Page<OrderRepostiory.CustomerOrderInfo> = orderRepository.findCustomerOrderByStore(store, paging)
