...
function Inventory(){
    ...
    const result = (loading) && item.data.data_list.slice(page*10, (page+1)*10).map((data, index) => {
        return <div style={{margin:"10px", borderBottom:"1px solid #D0D3D9", height:"45px", display:"flex", width:"96.5%", backgroundColor:isHovering[index]}}>
            ...
            {(modalopen[index]) && <Modal style={modalstyle} isOpen={modalopen[index]}>
                        <p style={{marginTop:"25px", marginLeft:"25px", fontSize:"35px", width:"150px"}}>점포 추가</p>
                        <p style={{marginTop:"25px", marginLeft:"25px", marginRight:"0px", fontSize:"30px"}}>CS25 빌리브 아카이브점</p>
                        <div style={imgbox}></div>
                        <div style={{display:"flex"}}>
                            <p style={{marginTop:"25px", marginLeft:"25px", width:"100px", fontSize:"25px"}}>주소</p>
                            <p style={{marginTop:"25px", marginLeft:"25px", marginRight:"0px", fontSize:"25px"}}>서울 중구 충무로3, 빌리브아카이브남산 109-1호, 109-2호 (필동1가 43-1)</p>
                        </div>
                        <div style={{display:"flex"}}>
                            <p style={{marginTop:"25px", marginLeft:"25px", width:"100px", fontSize:"25px"}}>전화번호</p>
                            <p style={{marginTop:"25px", marginLeft:"25px", marginRight:"0px", fontSize:"25px"}}>02 0000 0000</p>
                        </div>
                        <div style={{display:"flex"}}>
                            <p style={{marginTop:"25px", marginLeft:"25px", width:"100px", fontSize:"25px"}}>신청일</p>
                            <p style={{marginTop:"25px", marginLeft:"25px", marginRight:"0px", fontSize:"25px"}}>23.11.05</p>
                        </div>
                        <p style={{marginTop:"25px", marginLeft:"25px", marginRight:"100px", fontSize:"30px"}}>점주</p>
                        <div style={{display:"flex"}}>
                ...
                >
                    ...
                    <div style={{width:"450px", textAlign:"left"}}>점포명</div>
                    <div style={{width:"300px", textAlign:"left"}}>점주</div>
                    <div style={{width:"500px", textAlign:"left"}}>주소</div>
                    <div style={{width:"150px", textAlign:"left"}}>신청일</div>
                </div>
            </div>
        </div> 
    })
    ...
    return <div style={boxstyle}>
        ...
        <p style={{marginTop:"10px", marginLeft:"10px", fontSize:"35px"}}>점포 추가</p>
            <p style={{marginTop:"40px", marginLeft:"10px", fontSize:"25px"}}>점포 추가가 승인되었습니다.</p>    
        ...
        <p style={{marginTop:"10px", marginLeft:"10px", fontSize:"35px"}}>점포 추가</p>
            <p style={{marginTop:"40px", marginLeft:"10px", fontSize:"25px"}}>점포 추가가 거절되었습니다.</p>    
            <button style={{marginLeft:"180px", marginTop:"120px", }} className={ModuleStyle.whiteSmallButton} onClick={() => {
