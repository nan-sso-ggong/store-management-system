...
function Inventory(){
    ...
    const result = (loading) && item.data.data_list.slice(page*10, (page+1)*10).map((data) => {
        return <div style={{margin:"10px", borderBottom:"1px solid #D0D3D9", height:"50px", display:"flex", width:"96.5%"}}>
        ...
        <div>
            <div style={{height:"750px"}}>
                <div style={{display:"flex"}}>
                    ...
                    <button style={{marginTop:"20px"}} className={ModuleStyle.blueButton} onClick={() => {setmodal(true)}}>상품 추가</button>
                </div>
                <div style={{display:"flex"}}>
